...
import ru.demoexam.template.ui.screens.OrderEditorScreen
                            ...
                            when (appState.currentScreen) {
                                ...
                                AppScreen.Products -> {
                                    ProductListScreen(
                                        ...
                                        supplierOptions = appState.supplierOptions,
                                ...
                                AppScreen.Orders -> {
                                    OrderListScreen(
                                        ...
                                        onRefresh = appState::refreshOrders,
                                        onAddOrder = { appState.openOrderEditor(orderId = null) },
                                        onEditOrder = { appState.openOrderEditor(it) },
                                        onDeleteOrder = appState::deleteOrder,
                                    )
                                }

                                is AppScreen.OrderEditor -> {
                                    val payload = appState.orderEditorPayload
                                    if (payload != null) {
                                        OrderEditorScreen(
                                            payload = payload,
                                            onSave = appState::saveOrder,
                                            onCancel = appState::goBack,
                                            onProductSelected = appState::orderProductPrices,
                                        )
                                    }
                                }
